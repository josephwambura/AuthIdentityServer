...
using IdentityServerAdmin.STS.Identity.Configuration;
using IdentityServerAdmin.STS.Identity.Configuration.ApplicationParts;
using IdentityServerAdmin.STS.Identity.Configuration.Constants;
using IdentityServerAdmin.STS.Identity.Configuration.Interfaces;
using IdentityServerAdmin.STS.Identity.Helpers.Localization;
...
namespace IdentityServerAdmin.STS.Identity.Helpers
{
            ...
            where TUserIdentity : class
        {
            ...
            var builder = services.AddIdentityServer(options => configurationSection.Bind(options))
                ...
                .AddOperationalStore<TPersistedGrantDbContext>(options =>
                {
                    ...
                    options.TokenCleanupBatchSize = 50;
                })
